...
void main_menu(){
	...
	transmitString_F(PSTR("|                                         |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     NAMAYANJA SWABRA                    |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     KAWUMA DANIEL                       |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     WASAANYI JAMES                      |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     SSENSALO EDGAR                      |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     NAMUTEBI JANET                      |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     MUKWAYA NICHOLAS                    |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     BATAIRE JONATHAN                    |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     BABIRYE SHARON VICTORIA             |"));
	TX_NEWLINE;
	transmitString_F(PSTR("|     MULINDWA HENRY                      |"));
	TX_NEWLINE;
	transmitString_F(PSTR("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"));
	TX_NEWLINE;
	transmitString_F(PSTR("                                           "));
